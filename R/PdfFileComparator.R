...
#' the second one is the file contents with the rowsmatching the omit string excluded.
#' This method can be overwritten by more specialized comparator classes. This method is intended
#' to be called only by the comparator classes in the processing and shouldn't be called directly
#' by the user.
#'
#' For PdfComparator, the file contents are returned based on the mode parameter if available.
#' "text" mode is the only supported option initally. "text" mode will return only the text
#' content part of the PDF file.
#'
